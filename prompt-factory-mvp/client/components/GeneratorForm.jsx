...
export default function GeneratorForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    experience_level: "student", // Default per demo
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 to-purple-100 p-4 font-sans">
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden p-8 md:p-12 transition-all duration-300">
        ...
        {!results && (
          <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in-up">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  className="w-full appearance-none bg-white border-2 border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all"
                >
            ...
            {/* 3. Tech Strategy (Chips + Conditional Input) */}
            <div>
            ...
            {/* 5. Target AI (Simple Select) */}
            <div>
              <label className="block text-gray-700 font-semibold mb-2">Target AI Model</label>
              <select
                name="target_ai"
                value={formData.target_ai}
                onChange={handleChange}
                className="w-full bg-gray-50 border-2 border-gray-200 text-gray-700 py-3 px-4 rounded-lg focus:outline-none focus:border-indigo-500"
              >
        ...
        {results && (
          <div className="space-y-6 animate-fade-in-up">
                ...
                <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <button 
                      ...
                      className="text-xs bg-white border border-gray-300 hover:border-indigo-500 text-gray-600 hover:text-indigo-600 px-3 py-1 rounded-md transition-colors"
                    >
                      Copy
                    </button>
                  </div>
                  <pre className="text-xs md:text-sm text-gray-600 whitespace-pre-wrap font-mono leading-relaxed bg-white p-4 rounded border border-gray-100">
                    {prompt.content}
                  </pre>
                </div>
              ))}
            ...
            <button
              ...
              className="w-full py-3 mt-4 rounded-xl font-semibold text-gray-600 border-2 border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all"
            >
